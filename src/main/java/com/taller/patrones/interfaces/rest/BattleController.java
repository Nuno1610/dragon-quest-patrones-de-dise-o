...
public class BattleController {
    ...
    public ResponseEntity<Map<String, Object>> startBattleFromExternal(@RequestBody Map<String, Object> body) {
        Character player = com.taller.patrones.interfaces.rest.adapter.ExternalApiCharacterAdapter.adapt(body, 1);
        Character enemy = com.taller.patrones.interfaces.rest.adapter.ExternalApiCharacterAdapter.adapt(body, 2);
